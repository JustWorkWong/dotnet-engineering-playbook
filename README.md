...
5. [模块化单体 vs 微服务](./docs/03-distributed-systems/modular-monolith-vs-microservices.md)
6. [OpenTelemetry + MAF 可观测性](./docs/04-observability/opentelemetry-maf-observability-guide.md)
7. [生产级埋点设计](./docs/04-observability/production-event-tracking.md)
8. [RAG / Workflow / Agent 分层实践](./docs/05-ai-coding/rag-workflow-agent-layering.md)
9. [Claude Code / Codex / ChatGPT 协作手册](./docs/05-ai-coding/claude-code-codex-chatgpt-playbook.md)
10. [面试定位与训练方法](./docs/06-interview/interview-positioning.md)
...
1. `OpenAPI vs gRPC vs Message` 的边界文档
2. `多租户 / 权限 / 审计` 的生产设计文档
3. `缓存 / 限流 / 重试 / 熔断` 的故障治理文档
